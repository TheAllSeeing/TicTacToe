...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        public void PutSymbolDialog(char symbol)
        {
           Sure = MessageBox.Show("Are you sure you want to put your " + symbol + " here?", "Are you sure?", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        }
        public void ChangeTurn()
        {
            ...
            TurnBox.Text = String.Format("Current Turn: Player {0} ({1})",PlayerNum,symbol);
